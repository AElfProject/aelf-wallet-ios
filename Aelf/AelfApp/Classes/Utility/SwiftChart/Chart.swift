...
open class Chart: UIControl {
    ...
    */
    open var labelFont: UIFont? = UIFont.systemFont(ofSize: 9)

    /**
    The color used for the labels.
    */
    @IBInspectable
    open var labelColor: UIColor = UIColor(hexString: "#333333")!
    ...
    */
    open var highlightLineColor = UIColor.clear

    /**
    Width for the highlight line.
    */
    open var highlightLineWidth: CGFloat = 0
    ...
    */
    ...
    func drawChart() {
        ...
        layerStore.forEach({ $0.removeFromSuperlayer() })
        ...
        if showXLabelsAndGrid && (xLabels == nil || !series.isEmpty) {
            drawLabelsAndGridOnXAxis()
        }
        if showYLabelsAndGrid && (yLabels == nil || !series.isEmpty) {
...
//        lineLayer.lineJoin = CAShapeLayerLineJoin.bevel
    ...
    fileprivate func drawArea(_ xValues: [Double], yValues: [Double], seriesIndex: Int) {
        ...
        animation.repeatCount = 1
        animation.duration = 1
        areaLayer.add(animation , forKey: "strokeEnd")
    ...
    fileprivate func drawLabelsAndGridOnXAxis() {
        ...
        scaled.enumerated().forEach { (i, value) in
            ...
            if x != 0 && x != drawingWidth {
                ...
                context.addLine(to: CGPoint(x: x, y: bounds.height - bottomInset))
                context.strokePath()
            }
            ...
            if xLabelsOrientation == .horizontal {
                ...
                label.frame.origin.x -= ((drawingWidth / CGFloat(labels.count)) - padding * 2)/2.0
    ...
    fileprivate func drawLabelsAndGridOnYAxis() {
        ...
        scaled.enumerated().forEach { (i, value) in
            ...
            label.textColor = UIColor.master.withAlphaComponent(0.8)
            label.sizeToFit()
