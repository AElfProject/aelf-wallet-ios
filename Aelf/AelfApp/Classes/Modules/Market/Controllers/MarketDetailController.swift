...
class MarketDetailController: BaseStaticTableController {
    ...
    let timeTrigger = BehaviorSubject<Int>(value: 1) // 1：24小时  2：近一周 3：近一月
...
//        self.priceMarketLabel.text =
    ...
    func updateView(klineSource: MarketTradeModel) {
        ...
        for (i, value) in array.enumerated() {
            ...
            let timeStamp = value.createTime.int
            if timeStamp != nil {
                ...
                if (labels.isEmpty  || i%indexCount == 0) {
